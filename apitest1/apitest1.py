...
class OptionExcelData(object):
    ...
    def __init__(self, excelFile='apitest1.xlsx', excelPath=''):
        self.excelFile = excelFile
        self.excelPath = excelPath
        self.caseList = []
        print (self.excelFile,self.excelPath)
    ...
    def getCaseList(self, excelFile='apitest1.xlsx', excelPath=''):
        readExcel = xlrd.open_workbook('apitest1.xlsx')  # 读取指定的Excel
        try:
    ...
    def writeCaseResult(self, resultBody, isSuccess, respTime, excelFile='apitest1.xlsx', theRow=1, theCol=5):
        writeExcel = openpyxl.load_workbook(excelFile)  # 加载Excel，后续写操作
        try:
            wtable = writeExcel.get_sheet_by_name('Sheet2')  # 获取名为Sheet1的sheet
